...
#define _OS_CFG_H
                                       ...
                                       /* ----------------------- uC/OS-View ------------------------- */
#define OS_VIEW_MODULE            0    /* Indicate that uC/OS-View is present                          */
...
#define OS_TASK_TIMING_STK_SIZE 128    /* Idle task stack size (# of OS_STK wide entries)              */
...
#define OS_TASK_TIMING_EN		  1		/* Enable the timing task													 */
...
#define OS_FLAGS_NBITS           16    /*     # of bits used for event flags                           */
